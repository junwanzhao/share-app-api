...
public class User {
    ...
    @TableId(value = "pk id", type = IdType.AUTO)
    ...
    @TableField(value = "delete flag", fill = FieldFill.INSERT)
    //@TableLogic：表示该字段是逻辑删除字段，在前文也有过配置描述
    @TableLogic
    private Integer deleteFlag;

    @TableField(value = "update time", fill = FieldFill.INSERT_UPDATE)
    private LocalDateTime updateTime;

    @TableField(value = "create time", fill = FieldFill.INSERT)
